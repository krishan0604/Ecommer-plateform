    ...
    <div className="min-h-screen bg-[#FCFBF7] flex flex-col items-center justify-center px-4 pt-32 pb-20">
      <div className="max-w-lg w-full reveal">
        <div className="text-center mb-16">
          <h1 className="text-6xl font-medium tracking-tighter mb-4 italic">Welcome.</h1>
          <p className="text-gray-500 font-light text-lg">Enter your credentials to continue.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-12 md:p-16 rounded-[48px] shadow-sm border border-gray-100 space-y-10 group">
          ...
          <button
            type="submit"
            className="w-full bg-black text-white py-8 rounded-full font-bold text-sm uppercase tracking-[0.2em] hover:scale-[1.03] transition-all shadow-2xl shadow-black/10 mt-6 flex items-center justify-center gap-3"
          >
        ...
        <p className="text-center mt-12 text-sm text-gray-400 font-light">
          New here? <Link to="/register" className="text-black font-bold hover:underline ml-2">Create an ID</Link>
        </p>
      </div>
    </div>
  );
